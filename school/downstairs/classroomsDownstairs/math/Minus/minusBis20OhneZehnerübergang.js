...
(function () {
  ...
  function generateQuestion() {
    let a, b;
    do {
      //do ist eine while Schleife, die mindestens einmal ausgeführt wird
      a = getRandomInteger(maxSum);
      b = getRandomInteger(a); // b <= a, Ergebnis >= 0
      // Wiederhole, solange die Einerstelle von a kleiner ist als die von b
    } while (a % 10 < b);
  ...
  backButton.onclick = () => {
    window.location.href = "./minusaufgabenauswahl.html";
  };
})();
